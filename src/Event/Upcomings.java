...
public class Upcomings extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jList1.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Cultural Dances", "Ticket Price - Rs 300.00", "Event ID - 202" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        ...
        jList2.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Modlin Show", "Ticket Price - Rs 300.00", "Event ID - 203" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        ...
        jList3.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Magic Show", "Ticket Price - Rs 300.00", "Event ID - 204" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        ...
        jList5.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Children Talent Show ", "Ticket Price - Rs 300.00", "Event ID - 205" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        ...
        jList6.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "Stage Dramas", "Ticket Price - Rs 300.00", "Event ID - 206" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
        ...
        jList7.setModel(new javax.swing.AbstractListModel<String>() {
            String[] strings = { "DJ Party", "Ticket Price - Rs 300.00", "Event ID - 207" };
            public int getSize() { return strings.length; }
            public String getElementAt(int i) { return strings[i]; }
        });
