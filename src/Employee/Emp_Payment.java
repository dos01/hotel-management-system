...
public class Emp_Payment extends javax.swing.JInternalFrame {
    ...
    {
        try{
            String sql="SELECT Empid,Name,Job,Basic_Salary,Gloss_Salary,Total_Deductions,Net_Salary from emp_payment";
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGap(18, 18, 18)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(NewRecord_button, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        if(empIdValid==true)
        {
           ...
           // allo_w.setModel(DbUtils.resultSetToTableModel(rs)); 
                ...
                {                       
                    ...
                    double OTr=(Salary/No_hours_month)*1.5;
    ...
    private void NewRecord_buttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_NewRecord_buttonActionPerformed
       ...
       if(leave_box.getText().equals("")){
        ...
        try{
            ...
            {
            try{            
                String sql="INSERT INTO emp_payment (empid,name,job,Basic_Salary,OT_Rate,Total_OTh,Total_OT_Amount,DateOf_Join,Medical,Bonus,Service_Charge,Travel,Rent,Other,epf,etf,Nopay,Insurance,Death_donations,Lateness,Gloss_Salary,Total_Deductions,Net_Salary) values ('"+id+"','"+name+"','"+job+"','"+bsal+"','"+otr+"','"+toth+"','"+totalOtA+"','"+doj+"','"+medical+"','"+bonus+"','"+service_ch+"','"+travel+"','"+rent+"','"+other+"','"+epf+"','"+etf+"','"+nopay+"','"+insurance+"','"+death_don+"','"+lateness+"','"+gsal+"','"+TotalD+"','"+Netsal+"')";            
                pst=con.prepareStatement(sql);
                pst.execute(); 
