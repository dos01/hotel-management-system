...
public class Emp_Registration extends javax.swing.JInternalFrame {
    ...
    {
        try{
            String sql="SELECT EmpId,NIC,Name,Gender,Contact_number,Job,bsal,doj,shift from empdetails";
    ...
    private void initComponents() {
        ...
        jDesktopPane1Layout.setVerticalGroup(
            ...
            .addGroup(jDesktopPane1Layout.createSequentialGroup()
                .addGap(5, 5, 5)
                .addComponent(img, javax.swing.GroupLayout.DEFAULT_SIZE, 134, Short.MAX_VALUE)
                .addContainerGap())
        );
    ...
    private void submitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitActionPerformed
        ...
        String doj=dojbox.getText();
        String shift=shiftc.getSelectedItem().toString();
        
        try{
           String q="INSERT INTO empdetails (nic,name,dob,gender,address,contact_number,email,job,bsal,doj,Shift,image) values ('"+nic+"','"+name+"','"+dob+"','"+gender+"','"+address+"','"+con_no+"','"+email+"','"+job+"','"+bsal +"','"+doj+"','"+shift +"','"+person_image+"')";
            ...
            try{
              ...
              //  jTable1.setModel(DbUtils.resultSetToTableModel(rs)); 
                ...
                {                
                    ...
                    dojbox.setText(rs.getString("doj"));
                    shiftc.setSelectedItem(rs.getString("shift"));
                }
             }
            catch(Exception e)
            {
                System.out.println("Error in searching at Reg");
                System.out.println(e.getMessage());
            }
...
/*
      ...
      String con_no=jTable1.getValueAt(r, 6).toString();
      String email=jTable1.getValueAt(r, 7).toString();
      String job=jTable1.getValueAt(r, 8).toString();
      String bsal=jTable1.getValueAt(r, 9).toString();
      String doj=jTable1.getValueAt(r, 10).toString(); 
      String shift=jTable1.getValueAt(r, 11).toString();
      
      id_lbl.setText(id);
      nicbox.setText(nic);
      namebox.setText(name);
      dobbox.setText(dob);
      gen_box.setSelectedItem(gender);
      addressbox.setText(address);
      contact_nobox.setText(con_no);
      emailbox.setText(email);
      jobbox.setText(job);
      bsalbox.setText(bsal);
      dojbox.setText(doj);
      shiftc.setSelectedItem(shift);
   ...
   */   
    ...
    private void DeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DeleteActionPerformed
        ...
        if(y==0)
        {
            ...
            String q1="INSERT INTO left_emp_details (empid,nic,name,dob,gender,address,contact_number,email,job,bsal,doj,Shift,image) values ('"+id+"','"+nic+"','"+name+"','"+dob+"','"+gender+"','"+address+"','"+con_no+"','"+email+"','"+job+"','"+bsal +"','"+doj+"','"+shift +"','"+person_image+"')";
    ...
    private void UpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_UpdateActionPerformed
     if(search_txt.getText().equals("")){
        ...
        String sql="UPDATE empdetails SET nic='"+nic+"',name='"+ name+"',dob='"+dob+"',gender='"+gender+"',address='"+address+"',contact_number='"+con_no+"',email='"+email+"',job='"+job+"',bsal='"+bsal+"',doj='"+doj+"',Shift='"+shift+"'where empid='"+id+"'";
